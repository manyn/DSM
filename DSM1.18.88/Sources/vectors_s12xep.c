...
extern void near  VW_ISR(void);         //LH
extern void near  TD_ISR(void);         //LH 
extern void near  RTC_ISR(void);        //LH
extern void near  SCI0_ISR(void);       //LH
/*
************************************************************************
...
const tIsrFunc _vect[] @0x7F10 = {//LH,for bootloader
        ...
        software_trapF0,               /* 0xF0: Real-Time Interrupt                    */
        VW_ISR,                        /* 0xF2: IRQ                                    */
